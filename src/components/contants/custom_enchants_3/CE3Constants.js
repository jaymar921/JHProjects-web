...
export const PluginInformation = {
  ...
  versionHighlight:
    "76 new enchantments and 100 new treasure items, which more than doubles both. Bandit camps now guard the loot plots, 25 quests ship ready to hand out, and the currency screen has a candlestick price chart. Tested on Minecraft 26.2.",
