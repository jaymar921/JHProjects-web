...
/**
 * Paying for Premium through Wise.
 *
 * The counterpart to FT_BUY_PayPal, and the same account Custom Enchantments
 * 3 uses, QR included. No Wise discount for now, so it is the same number
            ...
            <Step n="2" accent="lime">
              ...
              <div className="mt-3 border border-slate-700/70 bg-[rgba(0,0,0,0.45)] p-3">
                <Field
                  ...
                  value={
                    price.onSale
                      ? `${amount} (sale price, normally ${wise.currencySymbol}${price.regularAmount})`
                      : amount
                  }
                />
                <Field
