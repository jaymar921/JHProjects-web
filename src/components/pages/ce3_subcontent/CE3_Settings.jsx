...
function CE3_Settings() {
  return (
    <div>
      <div className="w-[30%] md:w-[20%] lg:w-[10%] m-auto border-2 border-gray-800 p-4 rounded-xl mt-8 select-none">
      ...
      <div className="w-[70%] m-auto">
        <p className="text-justify select-none">
          You can download the default/custom plugin settings or contribute a
          custom plugin settings for others to use
        </p>
