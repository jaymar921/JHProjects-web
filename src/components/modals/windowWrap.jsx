 ...
 * Economy emerald, Epic Mobs Rework ember, Farm Tales green, Custom Warps
 * violet and Fishing Contest cyan. All are written out in full so Tailwind keeps them.
 */
const ACCENTS = {
  ember: {
